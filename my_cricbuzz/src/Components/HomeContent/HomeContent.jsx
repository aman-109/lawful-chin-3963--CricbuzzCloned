...
useEffect(()=>{
axios.get('https://cricbuzz-cricket.p.rapidapi.com/news/v1/index',
{headers: {
...
//  console.log(res.data.storyList)
...
// console.log(news[0].story);



  return (
    <>
      <Box mt={"0.3rem"} border="1px solid" display={"flex"} justifyContent="space-between" gap={"0.3rem"}>
        <Box w="196px" p={2} bg="#fff" border="1px solid ">
          ...
          {
           news && news.map((ele)=>(
             ele.story && <NewsComp key={ele.id} title={ ele.story.hline}
